...
export function ProjectDeleteDialog({ isOpen, onClose, onDeleted, project }: ProjectDeleteProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-sm w-full mx-4">
        ...
        <div className="p-6 space-y-4">
          ...
          <p className="text-slate-600">
            Are you sure you want to delete <strong>{project.name}</strong>? This will also delete all associated activities and tasks.
          </p>
